...
public class AvoidWallsStrategyTests
{
	...
	public void WhenSnakeIsNextToLeftWall_ThenScoresAreReducedForMovesTowardsWall()
	{
		...
		board.AddSnake("snakeId", 100, new List<Coordinate>
		{
		...
		directionScores.Left.ShouldBeLessThan(0); // Reduced score towards wall
	...
	public void WhenSnakeIsNextToRightWall_ThenScoresAreReducedForMovesTowardsWall()
	{
		...
		directionScores.Right.ShouldBeLessThan(0); // Reduced score towards wall
	}
	...
	public void WhenSnakeIsNextToTopWall_ThenScoresAreReducedForMovesTowardsWall()
	{
		...
		var directionScores = AvoidWallsStrategy.CalculateDirectionScores(board);
		// Assert
		directionScores.Up.ShouldBeLessThan(0); // Reduced score towards wall
		directionScores.Down.ShouldBe(0);
		directionScores.Left.ShouldBe(0);
		directionScores.Right.ShouldBe(0);
	}
	...
	public void WhenSnakeIsNextToBottomWall_ThenScoresAreReducedForMovesTowardsWall()
	{
		...
		// Assert
		directionScores.Up.ShouldBe(0);
		directionScores.Down.ShouldBeLessThan(0); // Reduced score towards wall
		directionScores.Left.ShouldBe(0);
		directionScores.Right.ShouldBe(0);
	}
	...
	public void WhenSnakeIsInBottomLeftCorner_ThenScoresAreReducedForBothWalls()
	{
		...
		// Assert
		directionScores.Up.ShouldBe(0);
		directionScores.Down.ShouldBeLessThan(0); // Reduced score towards bottom wall
		directionScores.Left.ShouldBeLessThan(0); // Reduced score towards left wall
		directionScores.Right.ShouldBe(0);
	}
}
